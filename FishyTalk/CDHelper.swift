...
class CDHelper {
    ...
    lazy var storesDirectory: NSURL = {
        ...
        // userâ€™s home directory = .DocumentDirectory
    ...
    lazy var localStoreURL: NSURL = {
        let url = self.storesDirectory.URLByAppendingPathComponent("FishyTalk.sqlite")
        return url
        }()
    ...
    lazy var modelURL: NSURL = {
        ...
        //This method allocates and initializes a bundle object if one doesnâ€™t already exist. The new object corresponds to the directory where the application executable is located. Be sure to check the return value to make sure you have a valid bundle. This method may return a valid bundle object even for unbundled applications.
    ...
    //2 An NSManagedObjectModel object describes a schemaâ€”a collection of entities (data models) that you use in your application.
